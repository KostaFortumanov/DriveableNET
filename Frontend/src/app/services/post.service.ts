...
export class PostService {
    ...
    getPosts(
        ...
        color: string,
        sortBy: string,
        carTypes: string[]): Observable<{postsResponse: Post[], size: number}> {
        return this.http.post<{postsResponse: Post[], size: number}>(`/api/posts`, {
            page: page,
            size: 10,
    ...
    getPostImage(postId: string, picture: number): Observable<Blob> {
